package com.IOSANgu4.domain.core;
...
public class IOUser implements UserDetails {
	...
	*/
	...
	public IOUser(String firstName, String lastName) {
		super();
    ...
    private Set<IOAuthority>  roles = new HashSet<IOAuthority>();;
    @Column
	...
	public Set<IOAuthority> getRoles() {
		return roles;
	}

	public void setRoles(Set<IOAuthority> roles) {
		this.roles = roles;
	}
